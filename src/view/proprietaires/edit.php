...
<form action='../../Proprietaires/update' method="post">
    ...
    <div class="row p-2">
        <select name="type_proprietaire" id="type_proprietaire" class="form-select form-select-lg mb-3">
            <?php
                foreach($data[1] as $type_proprietaire)
                {
  ...
  <div class="row">
    ...
    <!-- nom et prenom -->
    <div class="col">
      <input type="text" name="prenom" id='prenom' value="<?=$data[0]->getPrenom()?>" class="form-control" placeholder="Prenom">
    </div>
    <div class="col">
      <input type="text" name='nom' id="nom" value="<?=$data[0]->getNom()?>" class="form-control" placeholder="Nom">
    </div>
  ...
  <div class="row my-4">
    ...
    <div class="col">
      <input type="text" name="lieu_naissance" class="form-control" value="<?=$data[0]->getLieu()?>" id="lieu" placeholder="Lieu de naissance">
    </div>
  </div>
  <!-- adresse et telephone -->
  <div class="row my-4">
    <div class="col">
      <input type="text" name="adresse" class="form-control" value="<?=$data[0]->getAdresse()?>" id="adresse" placeholder="Adresse">
    </div>
    <div class="col">
      <input type="text" name="telephone" class="form-control" value="<?=$data[0]->getTelephone()?>" id="telephone" placeholder="Téléphone">
    </div>
  </div>
    <!-- cni et nationalite -->
  <div class="row my-4">
    <div class="col">
      <input type="text" name="cni" class="form-control" value="<?=$data[0]->getCni()?>" id="cni" placeholder="Numero de CNI">
    </div>
    <div class="col">
      <input type="text" name="nationalite" class="form-control" value="<?=$data[0]->getNationalite()?>" id="nationalite" placeholder="Nationalité">
    </div>
   </div>
   <div class="row my-4">
